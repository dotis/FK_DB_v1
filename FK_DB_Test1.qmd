...
# roi   = "FKNMS"
# Set Bounds
# site <- read_csv("data/ROI_INFO.csv", col_types=cols())   # Pull ROI bounds from file. Define manually for now.
slat <- 24.0; nlat <- 26; wlon <- -83.0; elon <- -80.0
date_tmp <- "2017-01-01"
...
#     time <- format(time_tmp,"%Y-%m-%dT00:00:00Z"))) # Use this to pull dates from somewhere else

#fitBounds(wlon, slat, elon, nlat) 
#fitBounds(-83.5,24.0,-78.5,26.0)
